...
| [`tools/validate_sdk.py`](validate_sdk.py) | SDK wheel 门禁：仓库外临时 venv、CPU/GPU 测试、S5 新建/导出、外部导入编辑及图像驱动的二次脚本修正，记录带 hash 的证据 | CPython 3.14、已构建的 wheel；GPU 及二次修正需真实 GPU |
