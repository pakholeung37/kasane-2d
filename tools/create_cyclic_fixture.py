#!/usr/bin/env python3
"""Generate an independent external v42 (csmMocVersion_42) MOC3 fixture for M3C Stage S3.
...
OUT_DIR = ROOT / "tests/fixtures/external_cyclic"
...
def build_cyclic_moc3():
    ...
    sections[54] = bytearray(struct.pack("<3i", 1, 0, 1)) # ParamX: repeat=1, ParamBS: repeat=1
...
print(f"Generated external cyclic fixture at {OUT_DIR}: {len(moc3_bytes)} bytes")
